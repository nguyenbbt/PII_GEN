...
class RunConfig(Schema):
    ...
    def support_legacy_config(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "seed_generation" in values and "faker" not in values:
            values["faker"] = values.pop("seed_generation")
    ...
    def normalise_language(cls, language: str) -> str:
        aliases = {"vietnamese": "vi", "vi-vn": "vi", "vi_vn": "vi"}
...
class GeneratedEntity(Schema):
    """One PII value generated by the LLM and present in ``tagged_text``."""
